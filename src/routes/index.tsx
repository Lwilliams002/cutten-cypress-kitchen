...
const menu = {
  "Pre-Game Bounties": [
    ["Honey Butter Cornbread", "Warm, fluffy cornbread topped with sweet honey butter — simple, comforting and delicious.", "$3"],
    ["Chicken Bites", "Crispy chicken bites seasoned with our signature spice blend, served with a side of aioli.", "$16"],
    ["Crawfish Egg Rolls", "Three crawfish-stuffed rolls loaded with bold seasoning and cream cheese, paired with aioli and sweet chili.", "$17"],
    ["Southwest Egg Rolls", "Crispy rolls filled with seasoned chicken, black beans, corn and pepper jack.", "$14"],
    ["Salmon Bites", "Tender salmon bites seasoned with zesty herbs, fried to a golden finish. Served with dipping sauce.", "$17"],
    ["Wings", "Crispy wings with bold sauces — buffalo, sweet chili, mango BBQ, lemon pepper or house sauce. 6pc $13 · 10pc $19.", "$13 / $19"],
    ["Crab Cakes", "Two savory crab cakes seasoned and seared to a golden crisp, topped with aioli.", "$24"],
    ["Brunch Sampler", "Two seasoned lamb chops, crispy tenders and eggs your way — served with grits, breakfast potatoes and greens.", "$34"],
    ["Deviled Eggs", "Classic deviled eggs served three ways. Plain $11 · w/ Chicken $15 · w/ Shrimp $17.", "$11 / $15 / $17"],
    ["Pick Your Dip", "Your choice of creamy queso or spinach dip served warm with crispy tortilla chips. Single $11 · Both $13.", "$11 / $13"],
  ],
  "Fresh Evidence (Salads)": [
    ["House Salad", "Crisp chopped greens, tomatoes and cucumbers. Choice of dressing: honey mustard, ranch, vinaigrette, blue cheese, Caesar or Thousand Island.", "$10"],
    ["Cobb Salad", "Crispy chicken tenders, tomatoes, savory bacon, creamy blue cheese, eggs and onions. Served with honey mustard on the side.", "$23"],
    ["Caesar Salad", "Crisp romaine, Parmesan and crunchy croutons tossed in creamy Caesar dressing with grilled chicken.", "$19"],
    ["Southwestern Salad", "Blackened chicken breast, sweet corn, black beans, tortilla strips, onions, cheese and juicy tomatoes with southwestern dressing.", "$23"],
  ],
  "Bounty Burgers & Sandwich Smugglers": [
    ["Po'Boy — Catfish / Shrimp", "Crispy fried shrimp or catfish with lettuce, tomato, pickles and tartar sauce on a po'boy bun. Catfish $23 · Shrimp $26.", "$23 / $26"],
    ["CK Burger or Patty Melt", "Brioche bun with bacon, lettuce, tomato, pickles, onions and cheese — or the patty melt with grilled onions, pub sauce and melted cheese on Texas toast.", "$22"],
    ["Sliders — Beef / Chicken", "Three hearty sliders with beef or chicken, pepper jack, lettuce, tomato, bacon and aioli, stacked on soft Hawaiian buns.", "$22"],
    ["CK Chicken Sandwich", "Grilled chicken with Swiss, lettuce, tomato and onions on a soft bun. Slathered with mango BBQ or honey mustard.", "$22"],
  ],
  "Main Heist (includes 2 sides)": [
    ["Chicken Fried Steak", "Crispy breaded steak served hot with a generous pour of creamy country gravy.", "$24"],
    ["Chicken Fried Chicken", "Juicy chicken breast breaded and fried to golden perfection, topped with smooth country gravy.", "$24"],
    ["Pork Chops Dinner", "Two pork chops grilled or fried to order with bold flavor and a western finish.", "$29"],
    ["Jerked Lamb Chops", "Half rack of tender Jamaican jerk lamb chops cooked to order — where island heat meets Western fire.", "$48"],
    ["CK Texas Meat Loaf", "Slow cooked and grilled with a house-made mango BBQ glaze.", "$25"],
    ["Ribeye (16oz)", "16oz ribeye grilled to your liking.", "$51"],
    ["Catfish Mardi Gras", "Fried or blackened catfish topped with Mardi Gras sauce and grilled shrimp.", "$29"],
    ["Fisherman's Choice", "Crispy fried shrimp $25 · golden fried catfish $27 · combo seafood platter $29 — served up Southern style.", "$25 / $27 / $29"],
    ["Blackened Salmon", "8oz blackened salmon seared with bold Cajun spices for a smoky flavor.", "$28"],
    ["Grilled Chicken", "Marinated char-grilled chicken breast.", "$26"],
    ["This Is Not Mama's Hamburger Helper", "Hearty ground beef, bold seasonings and creamy sauce — definitely not from a box.", "$22"],
  ],
  "Brunch Bandits (All Day)": [
    ["Shrimp & Grits", "Seasoned grits topped with grilled shrimp.", "$26"],
    ["Catfish & Grits", "Seasoned grits topped with blackened catfish.", "$24"],
    ["Catfish + Shrimp & Grits", "Seasoned grits topped with blackened catfish and grilled shrimp.", "$28"],
    ["Salmon on Toast", "8oz grilled salmon served on a crispy slice of Texas toast with eggs your way.", "$27"],
    ["Seafood Omelette", "A fluffy omelette filled with shrimp, crawfish tails and fresh vegetables, seasoned to perfection.", "$26"],
    ["Fried Chicken Omelette", "Fluffy omelette with crispy fried chicken and breakfast potatoes, topped with country gravy.", "$24"],
    ["Gold Rush Toast", "Golden french toast dusted with powdered sugar. Classic $15 · Cream-stuffed $19.", "$15 / $19"],
    ["Chicken & Waffles", "Golden fried chicken wings paired with a fluffy waffle.", "$23"],
    ["Lamb & Eggs", "Juicy Jamaican jerk lamb paired with breakfast potatoes and eggs your way.", "$48"],
    ["Tenders & Pancakes", "Crispy chicken tenders served with warm fluffy pancakes and maple syrup.", "$21"],
    ["Breakfast Bowl", "Scrambled eggs, crispy bacon, chicken tenders and cheese over a base of potatoes with aioli.", "$22"],
    ["CK Breakfast", "Eggs your way, breakfast potatoes, bacon and sausage served with a fluffy pancake.", "$21"],
    ["French Toast Sliders", "Crispy chicken, golden french toast, eggs your way with melted cheese and bacon on the side. Maple glaze included.", "$25"],
  ],
  "Accomplice Additions (Sides)": [
    ["Mashed Potatoes", "", "$8"],
    ["Onion Strings", "", "$8"],
    ["Collard Greens", "", "$8"],
    ["Fried Okra", "", "$8"],
  ...
  "Little Outlaws (Kids, w/ golden fries)": [
    ["Grilled Chicken Wrangler", "", "$10"],
    ["Cowboy Burger", "", "$10"],
    ["Corndog on a Stick", "", "$10"],
    ["Lil' Tenders", "", "$10"],
  ],
  "The Lunch Lineup (Mon–Fri 10a–3p)": [
    ["Southwestern Egg Rolls", "Appetizer — chicken, corn, black beans and spinach with southwestern sauce.", "$7"],
    ["Deviled Eggs", "Appetizer — Chicken $7 · Shrimp $9.", "$7 / $9"],
    ["Spinach & Artichoke Dip", "Appetizer — served with fresh corn chips.", "$5"],
    ["Fried Catfish", "Deep fried catfish filet.", "$16"],
    ["Jerked Lamb Chops", "Grilled Jamaican jerk lamb chops.", "$19"],
    ["Pork Chop", "Grilled or fried.", "$13"],
    ["Wings & Fries", "Flavors: buffalo, sweet chili, BBQ, mango BBQ, house sauce and lemon pepper.", "$15"],
    ["Po'Boy & Fries", "Catfish or shrimp with lettuce, tomato, pickles and tartar sauce.", "$15"],
    ["Hamburger", "Lettuce, tomato, pickles, onions, mustard and mayo.", "$16"],
    ["Salmon", "Grilled or blackened, cooked to temperature.", "$18"],
  ],
  "Saloon Sweets": [
    ["Pecan Pie", "", "$10"],
    ["Brownie", "", "$10"],
  ...
  "The Cutten Pour (Cocktails)": [
    ["Blueberry Lemon Drop", "A refreshing twist on the classic featuring tart blueberries and zesty lemon over a smooth house-frozen lemon drop.", "$15"],
    ["Deep Cut", "Classic lemon drop with Deep Eddy's Lemon Vodka, fresh lemon juice and a touch of sweetness. Served chilled with a sugar rim.", "$12"],
    ["Raspberry Rio Mojito", "A bold Texas twist on the classic with fresh raspberries, mint, lime, premium white rum and sparkling soda. Light, sweet and crisp.", "$12"],
    ["Island Ting", "Our house-made frozen margarita meets a vibrant punch — a tropical escape in every sip. Sweet, tangy and refreshingly smooth.", "$14"],
    ["Bayou Berry Smash", "A bold take on the whiskey sour with smooth whiskey, house-made sour blend and fresh muddled berries. Sweet, tart and full of southern charm.", "$12"],
    ["Pineapple Upside Crown", "Made with Crown Royal Vanilla, fresh pineapple juice and a touch of caramelized cherry sweetness. Smooth with a tropical kick.", "$14"],
    ["Sittin' Sideways", "A Cutten twist on a classic — peach or passion fruit infused sidecar over our house-made frozen margarita. Citrus sweetness with Texas swagger.", "$16"],
    ["CK Specials", "Choose a refreshing frozen margarita, citrusy lemon drop, smooth cosmopolitan or bold sidecar. Single $8 · Double $16 · Flight of 4 $18.", "$8 / $16 / $18"],
    ["Traditional Flight (Mimosa)", "Refreshing mimosa flight with four flavors: tropical pineapple, classic orange, tangy cranberry and zesty grapefruit.", "$19"],
    ["Tropical Flight (Mimosa)", "Vibrant mimosa flight with mango, passion fruit, wild berry and a juicy touch of strawberry.", "$21"],
  ],
};
