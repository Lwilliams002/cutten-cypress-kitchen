...
const menu = {
  "Pre-Game Bounties": [
    ["Honey Butter Cornbread", "", "$3"],
    ["Chicken Bites", "", "$16"],
    ["Crawfish Egg Rolls", "", "$17"],
    ["Southwest Egg Rolls", "", "$14"],
    ["Salmon Bites", "", "$17"],
    ["Wings", "6pc $13 · 10pc $19", "$13 / $19"],
    ["Crab Cakes", "", "$24"],
    ["Brunch Sampler", "", "$34"],
    ["Deviled Eggs", "Plain $11 · w/ Chicken $15 · w/ Shrimp $17", "$11 / $15 / $17"],
    ["Pick Your Dip", "Queso or Spinach $11 · Both $13", "$11 / $13"],
  ],
  "Fresh Evidence (Salads)": [
    ["House Salad", "", "$10"],
    ["Cobb Salad", "", "$23"],
    ["Caesar Salad", "", "$19"],
    ["Southwestern Salad", "", "$23"],
  ],
  "Bounty Burgers & Sandwich Smugglers": [
    ["Po'Boy", "Catfish $23 · Shrimp $26", "$23 / $26"],
    ["CK Burger or Patty Melt", "", "$22"],
    ["Sliders", "Beef or Chicken", "$22"],
    ["CK Chicken Sandwich", "", "$22"],
  ],
  "Main Heist (includes 2 sides)": [
    ["Chicken Fried Steak", "", "$24"],
    ["Chicken Fried Chicken", "", "$24"],
    ["Pork Chops Dinner", "", "$29"],
    ["Jerked Lamb Chops", "", "$48"],
    ["CK Texas Meat Loaf", "", "$25"],
    ["Ribeye (16oz)", "", "$51"],
    ["Catfish Mardi Gras", "", "$29"],
    ["Fisherman's Choice", "Crispy Fried Shrimp $25 · Golden Fried Catfish $27 · Combo Seafood Platter $29", "$25 / $27 / $29"],
    ["Blackened Salmon", "", "$28"],
    ["Grilled Chicken", "", "$26"],
    ["This Is Not Mama's Hamburger Helper", "", "$22"],
  ],
  "Brunch Bandits (All Day)": [
    ["Shrimp & Grits", "", "$26"],
    ["Catfish & Grits", "", "$24"],
    ["Catfish + Shrimp & Grits", "", "$28"],
    ["Salmon on Toast", "", "$27"],
    ["Seafood Omelette", "", "$26"],
    ["Fried Chicken Omelette", "", "$24"],
    ["Gold Rush Toast", "Classic $15 · Cream-Stuffed $19", "$15 / $19"],
    ["Chicken & Waffles", "", "$23"],
    ["Lamb & Eggs", "", "$48"],
    ["Tenders & Pancakes", "", "$21"],
    ["Breakfast Bowl", "", "$22"],
    ["CK Breakfast", "", "$21"],
    ["French Toast Sliders", "", "$25"],
  ],
  ...
  "The Lunch Lineup (Mon–Fri 10a–3p)": [
    ["Southwestern Egg Rolls", "Appetizer", "$7"],
    ["Deviled Eggs", "Chicken $7 · Shrimp $9", "$7 / $9"],
    ["Spinach & Artichoke Dip", "Appetizer", "$5"],
    ["Fried Catfish", "", "$16"],
    ["Jerked Lamb Chops", "", "$19"],
    ["Pork Chop", "", "$13"],
    ["Wings & Fries", "", "$15"],
    ["Po'Boy & Fries", "", "$15"],
    ["Hamburger", "", "$16"],
  ...
  "The Cutten Pour (Cocktails)": [
    ["Blueberry Lemon Drop", "", "$15"],
    ["Deep Cut", "", "$12"],
    ["Raspberry Rio Mojito", "", "$12"],
    ["Island Ting", "", "$14"],
    ["Bayou Berry Smash", "", "$12"],
    ["Pineapple Upside Crown", "", "$14"],
    ["Sittin' Sideways", "", "$16"],
    ["CK Specials", "Single $8 · Double $16 · Flight of 4 $18", "$8 / $16 / $18"],
    ["Traditional Mimosa Flight", "Pineapple · Orange · Cranberry · Grapefruit", "$19"],
    ["Tropical Mimosa Flight", "Mango · Passion Fruit · Wild Berry · Strawberry", "$21"],
  ],
};
